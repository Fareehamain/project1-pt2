...
namespace project1_pt3.Controllers
{
    public class CRUDController : Controller
    {
        ...
        //Create
        [HttpPost]
        public ActionResult create(project_1_pt3.Employee model)
        {
        ...
        public ActionResult Update(int Employeeid, project_1_pt3.Employee model)
        {
            using(var context = new EmployeesEntities())
            {
